...
class Simulation extends PerformanceTestRunner {
  ...
  setup("SoleTraderWithoutID", "Sole Trader without ID Journey").withChainedActions(
    getAuthLoginPage,
    postAuthLoginPage("individual"),
    getIndexPage,
    getIndividualRegistrationType,
