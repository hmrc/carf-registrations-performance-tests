...
# carf-registrations-performance-tests

Performance test suite for the `CARF Registration`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
